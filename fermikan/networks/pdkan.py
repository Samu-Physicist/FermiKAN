...
class FermiKAN_Orbitals(hk.Module):
    def __init__(self, orbitals_config: list[tuple[int, int]], Z_atoms: tuple[int, ...], num_electrons: int = 2, num_determinants: int = 1, n_up: int = None, n_down: int = None, name: str | None = None):
        super().__init__(name=name)
