...
def main(argv):
    ...
    print("=== Starting PD-KAN LiH Experiment ===")
    
    # 1. Get default FermiNet config
    config = base_config.default()
    
    # Li (3e) + H (1e) = 4e. Singlet state: 2 up, 2 down
    ...
    config.optim.lr.rate = 1.0e-5  # LAMB allows slightly larger LR
